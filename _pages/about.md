...
My research, from a Bayesian perspective, spans Directed and Undirected Graphs, High-Dimensional Graphical Models, Sparse Network Estimation, Hierarchical Models and Bayesian Variable Selection. I have been increasingly drawn to Spatial Statistics, Variational Bayes Algorithms, Computational Statistics and Functional Data Analysis. On the application side, my focus lies in Gene Networks, Cancer Biology, Genomics, Single Cell Seq Data, Spatial Transcriptomics, and Magnetic Resonance Imaging.

I earned _Ph.D._ in _Biostatistics_ under the watchful eye of <span style ="color:blue">[Jeremy Gaskins, PhD](https://louisville.edu/sphis/directory/jeremy-gaskins-phd)</span> and <span style ="color:blue">[Riten Mitra, PhD](https://louisville.edu/sphis/directory/riten-mitra)</span>, from <span style ="color:blue">[University of Louisville; Louisville, KY, USA](https://louisville.edu/)</span> in Fall 2022. My work was focused on method development for high-dimensional sparse Bayesian graphical estimation and heterogeneous joint network estimation, with applications to multiple cancer datasets. Prior to my graduation, I won the Doctoral Dissertation Completion Award from the Graduate School of University of Louisville.
