...
Application wise, I focus on advanced biostatistical methods for cancer research through integrative imaging technologies like Spatial Transcriptomics (ST), and Spatial Multiplex-Immunoprofiling (mIF). My current aim is to develop methods and analytical tools for Spatial Cancer Systems Biology aiding Precision Medicine. Additionally, I also apply my skills in building methods, enhancing the interpretation of Magnetic Resonance Imaging (MRI) data.
